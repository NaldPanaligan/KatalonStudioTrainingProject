...
def tearDown() {
	// Put your code here.
	WebUI.callTestCase(findTestCase('ReusableTestCases/TestSuiteTeardown'), [:], FailureHandling.OPTIONAL)
}
...
def tearDownTestCase() {
	// Put your code here.
	WebUI.callTestCase(findTestCase('ReusableTestCases/TestCaseTeardown'), [:], FailureHandling.OPTIONAL)
}
