...
category_link = CustomKeywords.'CustomKeywords1.categories_select'(categories)
...
WebUI.click(findTestObject('Page_Demo Web Shop. ProductDetails/Add to Cart Button'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('Page_Demo Web Shop. ProductDetails/Add Shopping Cart Message'), 2)

WebUI.verifyElementText(findTestObject('Page_Demo Web Shop. ProductDetails/Add Shopping Cart Message'), 'The product has been added to your shopping cart')
